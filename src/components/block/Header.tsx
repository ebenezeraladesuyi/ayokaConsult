  ...
  return (
    <div className={`w-full h-[90px] lg:h-[130px flex justify-center items-center shadow-m font-pop fixed z-40 bg-transparent text-white  shadow-m `}>
        <div className="w-[90%] h-full flex flex-co justify-between items-center ">
            ...
            <NavLink to='/'>
                <div className='lg:hidde p- rounded-md bg-white shadow-md w-[40px] md:w-[55px] md:[70px] z-40'>
                    <img className="w-full rounded-md " src={logo} alt="W2H-logo" />
            ...
            <div className='lg:bg-white lg:bg-opacity-4 rounded-[30px] lg:shadow-md p-3'>
                <li className="hidden lg:flex items-center gap-5 text-[15px] transition-all duration-500 ease-in-out">
                    ...
                    <Link offset={-100} smooth={true} duration={500} to="testimonies">
                        <ol className='text-black  hover:text-[#eedfb0] cursor-pointer font-semibold transition-all duration-300 ease-in-out'>Testimonies</ol>
                    </Link>
            ...
            <div className={` ${dropdown ? 'transform translate-x-0' : 'transform -translate-y-full'} lg:hidden w-full h-[100vh] absolute bg-whit backdrop-blur-m bg-black bg-opacity-60 top-0 transition-all ease-in-out z-30 duration-300`} onClick={showDropdown}>
                <div className="w-full h-[320px]  flex flex-col pl-[15px] sm:pl-[35px] pt-[25px] text-[13px] gap-4 text-[#1f2035] top-[70px] absolute ">
                    {/* <li className="lg:flex items-center gap-5 text-[16px]"> */}
                        ...
                        <Link offset={-100} smooth={true} duration={500} to="testimonies">
                            <ol className='text-white  hover:text-[#eedfb0] cursor-pointer font-semibold transition-all duration-300 ease-in-out'>Testimonies</ol>
                        </Link>
